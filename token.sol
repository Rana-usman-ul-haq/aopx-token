...
contract AOPX is ERC20, Ownable {
    using SafeMath for uint256;

    uint256 public transactionFeeRate = 5; // 5 = 0.05% transaction fee
    address public feeCollector = 0x530071d81E2E7467de1C06984E1545bc9B920c00;
    mapping (address => bool) public isBlackListed;
    mapping (address => bool) public _isExcludedFromFee;

    constructor() ERC20("AOPX", "AOPX") {
        _mint(msg.sender, 17300000 * 10 ** decimals());

        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[feeCollector] = true;
    }
    ...
    function _transfer(
        ...
        if (!_isExcludedFromFee[sender] && !_isExcludedFromFee[recipient]){
            // TRANSACTION FEE
            uint256 fee = amount.mul(transactionFeeRate).div(10000);
